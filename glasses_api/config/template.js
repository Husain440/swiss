                      ...
                      <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                          <td style="text-align: center; padding-left: 5px; padding-right: 5px;">
                            ...
                            <p><a href="" style="color: rgb(147, 10, 181);">Unsubscribe</a></p>
                          </td>
                        </tr>
                      </table>
                    </td>
...
exports.sendOtp = function(result,callback)
{
    ...
    <head>
      ...
      <meta http-equiv="X-UA-Compatible" content="IE=edge">
      <meta name="x-apple-disable-message-reformatting">
      <title>${process.env.APP_NAME} - sendotp</title>
      <link href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700" rel="stylesheet">
      <style>
        html,
        body {
              ...
              <td class="bg_white">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                  ...
                  <tr>
                    <td class="bg_white" style="padding: 0 50px 30px">
                      <div class="heading-section" style="text-align: center; padding: 0 30px;">
                        <a href="" class="btn btn-primary">OTP is ${result.otp}</a>
                      </div>
                    </td>
                  </tr>
                  <tr>
