  ...
  (n.prototype.init = function () {
    a("#world-map-markers").vectorMap({
      ...
      a("#usa-vectormap").vectorMap({
        map: "us_merc_en",
        backgroundColor: "transparent",
        regionStyle: { initial: { fill: "#4fc6e1" } },
      }),
      a("#india-vectormap").vectorMap({
        map: "in_mill_en",
        backgroundColor: "transparent",
        regionStyle: { initial: { fill: "#f7b84b" } },
      }),
      ...
      a("#chicago-vectormap").vectorMap({
        ...
        backgroundColor: "transparent",
        regionStyle: { initial: { fill: "#6658dd" } },
      }),
      a("#uk-vectormap").vectorMap({
        map: "uk_mill_en",
        backgroundColor: "transparent",
        regionStyle: { initial: { fill: "#4a81d4" } },
      }),
      a("#canada-vectormap").vectorMap({
        map: "ca_lcc_en",
        backgroundColor: "transparent",
        regionStyle: { initial: { fill: "#f1556c" } },
      }),
